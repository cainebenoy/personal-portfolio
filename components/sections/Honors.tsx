...
export default function Honors() {
  return (
    <section id="honors" className="relative z-10 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {honors.map((honor, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative rounded-xl border-2 border-dashed border-gray-300 bg-white/40 p-8 backdrop-blur-sm transition-all duration-300 hover:border-highlight hover:bg-white/60 hover:shadow-lg"
              >
                {/* Icon */}
                ...
                <p className="font-hand text-lg text-gray-600 mb-4">{honor.category}</p>
